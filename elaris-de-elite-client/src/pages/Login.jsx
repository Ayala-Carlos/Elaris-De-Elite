      ...
      <div className="flex flex-col md:flex-row gap-8 w-full max-w-5xl items-stretch">
        ...
        <div className="w-full md:w-1/2 p-12 bg-white rounded-[2.5rem] flex flex-col justify-center shadow-lg border border-gray-100">
          <div className="max-w-sm mx-auto w-full">
            <h1 className="text-2xl font-bold text-[#5c4d42] text-center mb-1">Iniciar sesión</h1>
            <p className="text-gray-400 text-xs text-center mb-8">Accede a tu cuenta para continuar</p>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div>
                <label className="block text-sm font-semibold text-[#5c4d42] mb-2">Correo electrónico</label>
                <input 
                  type="email" 
              ...
              <div>
                <label className="block text-sm font-semibold text-[#5c4d42] mb-2">Contraseña</label>
                <input 
                  type="password" 
                  className="w-full px-4 py-3 rounded-2xl bg-[#f9f4ef] border-none focus:ring-2 focus:ring-[#d4ac80] outline-none transition-all"
                  placeholder="••••••••"
              ...
              <div className="flex items-center justify-between text-[11px]">
                <label className="flex items-center text-gray-400 cursor-pointer select-none">
                  <input type="checkbox" className="mr-2 rounded border-gray-300 text-[#d4ac80] focus:ring-[#d4ac80]" />
                  Recordarme
                </label>
                <a href="#" className="text-[#5c4d42] font-semibold hover:underline">¿Olvidaste tu contraseña?</a>
              </div>

              {/* Botón Principal */}
              <button className="w-full bg-[#d4ac80] hover:bg-[#c59d6f] text-white font-bold py-4 rounded-xl transition-all shadow-md active:scale-[0.98]">
                Iniciar sesión
              </button>
            </form>
