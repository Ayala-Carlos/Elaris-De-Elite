        ...
        <div className="flex-1 flex flex-col gap-6">
          <div>
            ...
            <p className="text-sm text-[#7a6a6a] mt-0.5">
              {esEdicion
                ? "Modifique los datos del código de descuento"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      ...
                      />
                      <span className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-[#a09090] font-semibold pointer-events-none">
                        %
                      </span>
                    </div>
                    {errors.porcentaje && (
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex gap-3">
                    {[
                      ...
                      >
                        <span
                          className={`w-2 h-2 rounded-full flex-shrink-0 ${form.estado === opt.value ? (opt.value === "activo" ? "bg-green-500" : "bg-red-400") : "bg-[#ccc]"}`}
                        />
                        {opt.label}
                      </button>
                    ))}
