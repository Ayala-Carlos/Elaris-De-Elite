      ...
      <div className="flex gap-0 px-4 pb-6">
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-2xl font-bold text-[#65554f]">
                Códigos de descuento
              </h1>
              <p className="text-sm text-[#8a7a7a] mt-0.5">
                Gestione sus códigos de descuento
              </p>
            </div>
            <button
              ...
              renderRow={(item) => {
                ...
                return (
                  <>
                    ...
                    <div className="text-[#65554f] font-medium text-sm text-center">
                      {porcentaje}%
                    </div>
                    <div className="text-[#65554f] font-medium text-sm text-center">
                      {fecha}
                    ...
                    <div className="flex justify-center">
                      <span
                        className={`px-4 py-1 text-xs font-semibold rounded-full text-white ${activo ? "bg-[#a3ceac]" : "bg-[#ef4444]"}`}
                      >
