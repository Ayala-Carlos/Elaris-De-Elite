...
registerCustomerController.register = async (req, res) => {
  //#1- Request the data that we need to create a new customer
  const {
    name,
    lastName,
    email,
...
registerCustomerController.verifyCode = async (req, res) => {
  try {
    ...
    console.log("Código que el usuario escribió: " + verificationCodeRequest);
    console.log("Código que está en el token: " + storedCode);
